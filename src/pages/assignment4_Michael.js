...
const csvUrl = 'https://gist.githubusercontent.com/hogwild/3b9aa737bde61dcb4d';
...
const Charts = () => {
  ...
  const xScaleBar = d3.scaleBand()
    .domain(station)
    .range([innerWidth, 0]); // replace it with the correct scale
  ...
  // Task 1: Complete the changeHandler function
  ...
  const changeHandler = (event) => {
    ...
    // console.log(event.target.value) //返回的是相应的 index（0-11)
